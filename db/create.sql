...
insert into products (name,description,code,symboliek,price,verzorging) values ('Sparkle Gratitude', 'Flamboyant, luxe én stijlvol tegelijk. Onze Deluxe imponeert met lange, opvallende stelen die speels boven de andere bloemen uitsteken en voor extra allure zorgen.', '869462356-7', 'dit boeket staat voor omhelzing', 32.00, 4);
