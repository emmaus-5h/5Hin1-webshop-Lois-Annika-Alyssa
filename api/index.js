...
function getProducts(request, response) {
  ...
  let data = []
  const sqlOpdracht = db.prepare('SELECT products.id AS id, products.name AS name, products.description AS description, products.symboliek AS symboliek, products.code AS code, products.price AS price FROM products ORDER BY products.name ASC')
...
function getProductById(request, response) {
  ...
  const sqlOpdracht = db.prepare('SELECT products.id AS id, products.name AS name, products.description AS description, products.symboliek AS symboliek, products.code AS code, products.price AS price FROM products WHERE id = ?')
